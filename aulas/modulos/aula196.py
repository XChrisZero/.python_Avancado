...
#t1.join()  # Aguarda a finalização da thread t3 antes de continuar a execução
...
while t1.is_alive() or t2.is_alive() or t3.is_alive():
    print('Ainda tem thread viva...')
    sleep(0.5)

print('Todas as threads finalizaram!')

for i in range(20): # Loop principal
    print(i)
    sleep(.5)
'''
...
class Ingressos:
    ...
    def comprar(self, quantidade: int):
        ...
        """
        # Tranca o método
        self.lock.acquire() # Bloqueia o método por dentro
