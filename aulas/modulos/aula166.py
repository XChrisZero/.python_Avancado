...
import calendar # Módulo para manipulação de calendários
...
'''for week in calendar.monthcalendar(2022, 12): # Retorna uma lista de semanas que contém listas de dias
    for day in week:
        if day == 0:
            continue
        print(day)'''