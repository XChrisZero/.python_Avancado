...
''' 
   if letra_digitada == palavra_secreta:
        print ( f'{len ( letra_digitada )} tentativas foram nescessarias para acertar!' )
...
'''
    ...
    palavra_secreta != letra_digitada
    letra_digitada = input ( f'tentativa numero {contagem_tentativas} \n' )
